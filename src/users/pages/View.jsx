      ...
      <div className="shadow border p-5 border-gray-200">
        <div className="md:grid grid-cols-4 gap-x-10">
          ...
          <div className="col-span-1">
            <img className='w-100' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/contemporary-fiction-night-time-book-cover-design-template-1be47835c3058eb42211574e0c4ed8bf_screen.jpg?ts=1734004864" alt="bookimage" />
          </div>
          {/* book details column */}
            ...
            <div className="flex justify-center items-center min-h-screen">
              <div className="bg-white rounded-2xl md:w-250 w-100">
                ...
                <div className="relative p-5">
                  ...
                  {/* book images in a row */}
                  <div className="md:flex flex-wrap my-4">
                    <img className='md:w-65 w-25 md:me-2 mb-3 md:mb-0' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/contemporary-fiction-night-time-book-cover-design-template-1be47835c3058eb42211574e0c4ed8bf_screen.jpg?ts=1734004864" alt="book" />
                  </div>
                </div>
              </div>
            </div>
